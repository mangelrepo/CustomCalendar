...
import com.mangelrepo.customcalendar.data.Event
import com.mangelrepo.customcalendar.view.BounceAnimator
...
class CustomCalendar : UICalendar, View.OnClickListener {
    ...
    override fun reload() {
        mAdapter?.let { mAdapter ->
            ...
            mTxtTitle.text = dateFormat.format(mAdapter.calendar.time).capitalize()
    ...
    fun setStateWithUpdateUI(state: Int) {
        this@CustomCalendar.state = state
