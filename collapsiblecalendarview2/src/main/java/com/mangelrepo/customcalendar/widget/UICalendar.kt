...
import com.mangelrepo.customcalendar.view.OnSwipeTouchListener
import java.util.*
...
abstract class UICalendar constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ScrollView(context, attrs, defStyleAttr) {
    ...
    var todayIconColor = Color.WHITE
        set(todayIconColor) {
            field = todayIconColor
            redraw()
    ...
    fun getSwipe(context: Context): OnSwipeTouchListener {
        if(mListenerSwipe != null){
            return mListenerSwipe as OnSwipeTouchListener;
        }else {
